// Adapted from https://github.com/plumelo/rollup-plugin-styler

import path from "path";
import fs from "fs-extra";
import { RawSourceMap, SourceMapConsumer } from "source-map-js";
import { isAbsolutePath, relativePath, resolvePath, normalizePath } from "./paths.ts";

export const hashRe = /\[hash(?::(\d+))?]/;
export const firstExtRe = /(?<!^|[/\\])(\.[^\s.]+)/i;
